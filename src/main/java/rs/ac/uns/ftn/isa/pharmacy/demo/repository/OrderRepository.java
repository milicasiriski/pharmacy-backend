...
public interface OrderRepository extends CrudRepository<Order, Long> {
    ...
    @Query(value = "SELECT o.id, deadline, pharmacy_admin_id FROM medicine_order AS o, pharmacy_user AS pu WHERE o.pharmacy_admin_id = pu.id and pu.pharmacy_id = :pharmacyId ", nativeQuery = true)
