...
public interface DermatologistRepository extends CrudRepository<Dermatologist, Long> {
    ...
    @Query(value = "SELECT version, city, country, latitude, longitude, street, id, email, password, enabled, last_password_reset_date, user_type, name, surname, rating FROM pharmacy_user WHERE user_type = 'DERMATOLOGIST'", nativeQuery = true)
    ...
    @Query(value = "SELECT DISTINCT d.version, d.city, d.country, d.latitude, d.longitude, d.street, d.id, d.email, d.password, " +
