...
public class TestConstants {
    ...
    public static Medicine MEDICINE_TEST_OBJECT = new Medicine(MEDICINE_ID, MEDICINE_UUID, MEDICINE_NAME,
            ...
            MEDICINE_TYPE, true, MEDICINE_RECOMMENDED_DOSE, MEDICINE_SIDE_EFFECTS, MEDICINE_ALTERNATIVES);
    ...
    public static MedicineReservationDto MEDICINE_RESERVATION_DTO_TEST_OBJECT =
            new MedicineReservationDto(MEDICINE_ID, PHARMACY_ID, new Date());
}
